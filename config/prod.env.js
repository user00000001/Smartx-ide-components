...
module.exports = {
  NODE_ENV: '"production"',
  BASE_URL: '"http://localhost:25770/"',
  API_URL: '"http://localhost:25770/api/v1/"',
  BC_URL: '"http://localhost:25770/api/v1/"',

  // PYTHON_URL: '"https://smartxcompiler1.ont.io/api/v2.0/python/compile"',
  // CSHARP_URL: '"https://smartxcompiler1.ont.io/api/v1.0/csharp/compile"',
  PYTHON_URL: '"http://localhost:8000/api/v1.0/python/compile"',
  CSHARP_URL: '"http://localhost:8000/api/v1.0/csharp/compile"',
  NODE_URL:'"http://localhost:25770"',
...
/*  GITHUB_CLIENT_ID: '"b603d248fc646222eb59"',
  ...
  RESTFUL_SERVER_TEST:'"http://localhost:25770"',
  RESTFUL_SERVER_MAIN:'"http://localhost:25770"',
